...
public class OnePopTrackerUtil {

    private static final Gson gson = new Gson();
    private final String url;

    public OnePopTrackerUtil(String url) {
        this.url = url;
    }

    public void sendMessage(OnePopTrackerPlayer dm) {
        new Thread(() -> {
            String strResponse = OnePopTrackerUUID.post(this.url)
                    .acceptJson()
